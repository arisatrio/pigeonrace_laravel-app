            ...
            <div class="row">
                <div class="col">
                    <ul class="nav nav-pills mb-3">
                        ...
                        <li class="nav-item">
                            <button wire:click="pos" type="button" class="btn text-white 
                                @isset($pos->id)
                                    @if($item->id === $pos->id) btn-primary @endif
                            ...
                            document.addEventListener('livewire:load', function () {
                                window.livewire.afterDomUpdate(() => {
                                    ...
                                    for (var i = 0; i < latlong.length; i++) {
                                        ...
                                        .bindPopup("<b>Nama Peserta / Loft : </b> <br>" + latlong[i][0])
                                        .addTo(mymap);
                                    };
                                });
